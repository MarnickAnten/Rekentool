...
with st.form("my_form"):
    ...
    # if submitted:
    #     st.write("Franchise", Franchise, "VasteKosten", VasteKosten, "VermogensKosten", VermogensKosten, 
    #              "Pensioenleeftijd", Pensioenleeftijd, "StartSalaris", StartSalaris, "n_scenarios", n_scenarios, "lft", lft, "V_0", V_0)
...
# Parameters:
Gebruik_Ervaringssterfte = True
# Premie_percentage = Input_pensioenbeleid[1][0] # Netto premie
Premie_percentage = 0.15
